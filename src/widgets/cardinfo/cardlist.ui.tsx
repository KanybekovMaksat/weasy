    ...
    <Box className="mb-[90px]">
      <div className="container">
        <Box sx={{ margin: "0 auto" }} className="text-center max-w-[648px] ">
          ...
          >
            С нашей платформой вы легко создадите стильный лендинг с продуманным
            модулем записи, удобным календарем и гибкими настройками. Все для
            упрощения работы специалистов и удобства ваших клиентов.
          </Typography>
        </Box>
        <Box
